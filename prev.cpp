...
int main() {
    cout << "ExGrev : Examination Grievance System " << endl;
    int isActive = 0;
    int choice = 0;
    do{
        ...
        while(choice != 19){
            switch(choice){
                case 1:{
                    choice = 0;
                    cout << endl << "1. Login" << endl << "2. Sign Up" << endl
                    << "3. Exit";
                    cin >> choice;
                    switch(choice){
                        case 1:{
                            ...
                            string input;
                            student * currentStudent = searchStudent(input);
                            if(currentStudent == NULL){
                                choice =  1;
                                break;
                            }
                            else{
                                choice = currentStudent->passwordFunction(2);
                                if(choice == 1 ){
                                    //UserMenu()
                                }
                            }
